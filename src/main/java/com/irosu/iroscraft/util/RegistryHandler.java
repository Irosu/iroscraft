...
public class RegistryHandler {
    ...
    public static final RegistryObject<Block> SPANISH_OMELETTE = BLOCKS.register("spanish_omelette", SpanishOmelette::new);
    ...
    public static final RegistryObject<Item> SPANISH_OMELETTE_BI = ITEMS.register("spanish_omelette", () -> new BlockItemBase(SPANISH_OMELETTE.get()));
